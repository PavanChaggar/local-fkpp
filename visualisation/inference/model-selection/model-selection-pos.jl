...
begin
    ...
    hidedecorations!(ax)
    hidespines!(ax)
    plot_roi!(get_node_id.(right_cortex), local_scaled_meanerror, cmap)
...
save(projectdir("visualisation/inference/model-selection/output/regional_mean_error_local_tau_pos.jpeg"), f)
